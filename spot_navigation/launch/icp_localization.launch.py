...
def generate_launch_description():
    ...
    node_params = os.path.join(
        get_package_share_directory('spot_navigation'), 'config', 'icp_localization_params.yaml')

    input_filters_config_path = os.path.join(
        get_package_share_directory('spot_navigation'), 'config', 'input_filters_velodyne_puck.yaml')
    
    icp_config_path = os.path.join(
        get_package_share_directory('spot_navigation'), 'config', 'icp.yaml')
